...
function ProductDetails() {
  ...
  function handleAddToCart() {
    ...
    if (attributes["touch id in keyboard"]) {
      //I added this condition to check if the attribute exists in the product details becasue other attrubutes like color, size, capacity are by default null
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 mt-10 mx-auto max-w-6xl">
      ...
      <div className="space-y-4">
          ...
          <div>
            ...
            <label className="flex items-center space-x-2">
              <input
                ...
                checked={hasTouchId}
                onChange={(e) =>
                  handleCheckboxChange("touch id in keyboard", e.target.checked)
                }
        ...
        {attributes["with usb 3 ports"] && (
          <div>
            <h2 className="text-lg font-semibold mb-2">With USB 3 ports:</h2>
            <label className="flex items-center space-x-2">
              <input
                type="checkbox"
